...
################################################################################
def eval_hess_vec_prod(vec, params, net, dataloader, evaluator, data_size, use_cuda=False):
    """
...
################################################################################
def min_max_hessian_eigs(net, dataloader, evaluator, data_size, rank=0, use_cuda=False, verbose=False, tol=1e-2):
    """
    ...
    def hess_vec_prod(vec):
        ...
        eval_hess_vec_prod(vec, params, net, dataloader, evaluator, data_size, use_cuda)
